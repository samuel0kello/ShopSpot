...
import com.samuelokello.network.cart.AddCartRequestDto
import com.samuelokello.network.cart.CartApiService
import com.samuelokello.network.cart.UpdateCartRequestDto
import com.samuelokello.repository.mapper.toDomain
import com.samuelokello.repository.mapper.toEntity
                ...
                try {
                    ...
                    if (existingProductIndex != -1) {
                        currentProducts[existingProductIndex] =
                            currentProducts[existingProductIndex].copy(
        ...
        override suspend fun removeItemFromCart(
            ...
            flow {
                try {
                    // Get current cart
                    val currentCart =
                        dao.getCurrentCart(userId)?.toDomain()
