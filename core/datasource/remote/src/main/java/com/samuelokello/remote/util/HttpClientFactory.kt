...
import com.samuelokello.core.domain.repository.AuthenticationRepository // Keep this
...
import kotlinx.coroutines.runBlocking // Or use a proper scope if needed
import kotlinx.serialization.json.Json
import org.koin.core.component.KoinComponent // Import KoinComponent
import org.koin.core.component.inject // Import inject

// Make HttpClientFactory a KoinComponent to easily inject
object HttpClientFactory : KoinComponent { // Implement KoinComponent
    // Inject AuthenticationRepository. This will be resolved when HttpClientFactory is accessed.
    // This assumes AuthenticationRepository is already defined in Koin elsewhere.
    private val authenticationRepository: AuthenticationRepository by inject()

    fun create(): HttpClient =
        // Removed AuthenticationRepository from parameters
        HttpClient(CIO) {
